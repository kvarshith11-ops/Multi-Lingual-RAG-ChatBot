...
class RAGPipeline:
    ...
    def answer(self, question: str, top_k: int = 10) -> str:
        ...
        for i, doc in enumerate(retrieved_docs, 1):
            print(f"\nChunk {i}:\n{doc.content[:500]}")  # print first 500 chars
        print("\n-------------------------------------\n")
...
4. If the answer is implied (for example, a moral or lesson from a story), infer it logically from the context.
5. Do NOT use any external knowledge.
6. If the answer cannot be found or inferred from the context, say clearly that the information is not available in the knowledge base.
